...
const createUser = async (req, res) => {
    try {
        ...
        const { name, lastName, gender, designation, employeeId, role, joiningDate, password, address, departMent, re_password, email, phone, reportingTo, workingCountry } = req.body
